	...
	public void putMarks(Course course, Student student, double newMark, MarkType markType) {
    	if (course.getEnrolledStudents().contains(student)) {
    		if (markType == enumerations.MarkType.FIRST_ATT) {
				course.getGradebook().get(student).getMark().setFirstAttestation(course.getGradebook().get(student).getMark().getFirstAttestation() + newMark) ;
    		}
    		else if (markType == enumerations.MarkType.SECOND_ATT) {
				course.getGradebook().get(student).getMark().setFirstAttestation(course.getGradebook().get(student).getMark().getSecondAttestation() + newMark) ;

    		}
    		else {
				course.getGradebook().get(student).getMark().setFirstAttestation(course.getGradebook().get(student).getMark().getFinalExam() + newMark) ;
